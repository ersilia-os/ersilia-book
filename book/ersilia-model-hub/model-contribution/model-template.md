...
**Release**: tagged version released via GitHub. By default, once a model is incorporated it will be assigned the first release (v1.0.0). Releases follow semantic versioning.
