...
This command serves a specified model as an API. It enables precalculation fetching and writting from isaura [Precalculation Store](precalculation-store.md)
