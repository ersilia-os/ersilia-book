...
We will be using the Ersilia Model Hub throughout the internship. Please follow the installation [instructions](/broken/pages/xenMKbpAv8JCcpCviZjg). If you have a UNIX machine (Linux or MacOS) you can install Ersilia directly. If you are using a windows machine you will need a Virtual Machine or a Windows Subsystem Linux (WSL).
