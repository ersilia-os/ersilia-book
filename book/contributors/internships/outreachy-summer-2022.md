...
As soon as you feel ready to start coding, you should change the _Status_ in the Spreadsheet Hub sheet from _To do_ to _In progress_. Please go to the next page to learn more about how to [Incorporate models to the hub](/broken/pages/JSSwpgsz3oVYihWKgFdN).

{% content-ref url="/broken/pages/JSSwpgsz3oVYihWKgFdN" %}
[Broken link](/broken/pages/JSSwpgsz3oVYihWKgFdN)
{% endcontent-ref %}
...
8. When you are ready to [start coding](/broken/pages/JSSwpgsz3oVYihWKgFdN), change the _Status_ to _In progress_.
